#'
#' This function is a builder function allowing to build function of class bibliodata
#'
#' @param biblio Object of class list. Each element of the list should be of class Datasettorep
#'
#' @rdname bibliodata
#' 
#' @examples 
...
#' 
#' str(example_bibliodata)
#'
#' @return Create an object of class Bibliodata.
#'
#' @export

bibliodata <- function(biblio){#accolade ouvrante de la fonction constructeur grand public bibliodata

cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Bibliodata : builder ~~~~~~~~~~~~~~~~~~ \n")

return(new("Bibliodata",biblio = biblio))

#accolade fermante de la fonction constructeur grand public bibliodata
}
